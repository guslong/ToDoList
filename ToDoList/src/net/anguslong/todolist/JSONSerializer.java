...
public class JSONSerializer {
	...
	public ArrayList<Task> loadTasks() throws IOException, JSONException {
		...
		try {
			...
			Log.d("JSON", "JSON array object: " + array.toString());
			
			
			// build the array of tasks from the json objects
			for (int i = 0; i < array.length(); i++ ) {
				tasks.add(new Task(array.getJSONObject(i))); // TODO this is throwing the exception
				//type mismatch somewhere
				Log.d("JSONSeralizer loaded this object: ", array.getJSONObject(i).toString());
			}
